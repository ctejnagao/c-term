...
// ㈱コムテックエンタープライズ 弥生会計 勘定科目一覧表 (全8頁)
...
const initialRulesData = [
  ...
  { keyword: 'コニカミノルタ', accountCode: '737', accountName: 'リース料', subAccountCode: '020', subAccountName: 'コニカミノルタ', taxType: '課対仕入10%', priority: 90 },
...
async function main() {
  console.log('--- 弥生会計 勘定科目マスタシード投入開始 ---');
  let masterCount = 0;
